...
//           headers: { Authorization: `Bearer ${user.token}` },
//         });
//         const res2 = await axios.get("http://localhost:3000/api/customers/", {
//           headers: { Authorization: `Bearer ${user.token}` },
//         });
//         const bills = res.data;
//         const bills2 = res2.data;
...
//           earningsMap[dateKey].earnings += bill.total || 0;
//           earningsMap[dateKey].profit += bill.profit || 0;
//           earningsMap[dateKey].due += bill.remainValue || 0;
//         });
...
//   );
//   const totalProfitAllTime = allData.reduce((acc, cur) => acc + cur.profit, 0);
//   const totalDueAllTime = allData.reduce((acc, cur) => acc + cur.due, 0);
...
//     0
//   );
//   const totalDueFiltered = filteredData.reduce((acc, cur) => acc + cur.due, 0);

//   return (
//     <div className="px-1 py-2 space-y-8">
//       {/* <h1 className="text-2xl font-bold text-gray-800">Earning Report</h1> */}
...
//           </div>
//           <div className="bg-red-50 text-red-800 border border-red-200 p-4 rounded-md">
//             <p className="text-sm">Filtered Due</p>
//             <p className="text-xl font-bold mt-1">
//               ${totalDueFiltered.toFixed(2)}
//             </p>
//           </div>
//         </div>
