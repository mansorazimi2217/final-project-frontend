...
//                   key={item.name}
//                   to={item.path}
//                   className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-[#006EBD] transition-colors rounded-lg hover:bg-[#E6F2FA] no-underline"
//                 >
//                   {item.name}
//                 </Link>
//               ))}
...
//                 style={{ textDecoration: "none" }}
//                 to="/login"
//                 className="px-4 py-2 text-sm font-medium text-gray-700 hover:text-[#006EBD] transition-colors no-underline"
//               >
//                 Sign In
//               </Link>
//               <Link
//                 style={{ textDecoration: "none" }}
//                 to="/register"
//                 className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-[#006EBD] to-[#0091EA] rounded-lg shadow hover:shadow-md transition-all hover:opacity-90 no-underline"
//               >
//                 Get Started
//               </Link>
//             </div>
...
//               className="md:hidden p-2 rounded-md text-gray-700 hover:text-[#006EBD] focus:outline-none focus:ring-2 focus:ring-[#006EBD]"
...
//       {isOpen && (
//         <div
//           className="fixed inset-0 bg-black bg-opacity-40 z-[90] md:hidden"
//           onClick={() => setIsOpen(false)}
//         />
//       )}
//     </>
